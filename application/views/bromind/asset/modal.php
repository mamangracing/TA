									...
									<div class="row">
										<div class="col-6 col-xl-6">
											<?php if($this->session->role_id == 3) { ?> 
												...
												?> 
												<a href="<?= base_url('landing_page/order_wa');?>" class="order-wa btn btn-danger form-control">Order Now</a>
												<?php 
											}
											?>
										</div>
...
<script type="text/javascript">
	...
	//https://api.whatsapp.com/send?phone=+6285156081146&text=Haloo saya berniat memesan prodak
</script>
